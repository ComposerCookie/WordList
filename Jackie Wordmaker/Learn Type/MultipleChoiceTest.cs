...
namespace Jackie_Wordmaker
{
    public partial class MultipleChoiceTest : Form
    {
        ...
        private void buttStart_Click(object sender, EventArgs e)
        {
            ...
            if (Editor.Instance.CurrentList.MyList.Count < 5)
            {
                MessageBox.Show(@"You need ATLEAST 4 words in your database before you use this feature", @"Error");
            ...
            MultipleChoice mc = new MultipleChoice(newList);
            mc.Show();
        }
    }
}
